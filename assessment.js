'use strict'; /** 'use strict'は細かい間違いもエラー表示してくれるもの  'const', 'let'　は　'var'　と違って書き換えができない*/
 ...
 assessmentButton.onclick = function()　/**　functionの代わりに　=> */ {
     const userName = userNameInput.value;
     if (userName.length === 0) { //0文字の時は処理を終了する。　'ガード句'
         return;
     }
